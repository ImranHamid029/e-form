...
<section class="features-area ">
    ...
    <div class="row justify-content-center pb-8" style="padding-bottom:64px;">
        <!-- Kredit Aneka Usaha -->
        <div class="col-12 col-sm-6 col-lg-3 d-flex justify-content-center mb-4">
            <div class=" single-features-area wow fadeInUp text-center" data-wow-delay="300ms" style="width:100%">
